...
public class GoRestTest {
    ...
    public void endToEndTest(){
        int userId=
        createUser("Russ","zvcvcbbxxsbb@gmail.com","male","Active");
    ...
    private int createUser(String name,String email,String gender,String status){
    ...
    private GoRestPojo updateUser(int id,String status){
